...
IMPORTANT: Before calling this tool, always state the appointment ID, date, and time of the appointment you are about to cancel, and explicitly ask the user to confirm that they want to proceed. Do not cancel without confirmation.
